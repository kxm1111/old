...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("访问地址：http://localhost:80/");
            System.out.println("index.jsp: http://localhost:80/index.jsp");
            System.out.println("Servlet /a: http://localhost:80/a");
        } catch (Exception e) {
            e.printStackTrace();
        }
